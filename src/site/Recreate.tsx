      ...
      <div className="lp-wrap">
        <Reveal>
          <div className="lp-chapter-head">
            ...
            <h2 id="recreate-h" className="t-h1">Film your version of a business&rsquo;s Reel.</h2>
    ...
    <div ref={ref} className="lp-pair">
      ...
      <div>
        <Phone large>
          ...
          <motion.div className="lp-wipe" aria-hidden initial={{ x: 0 }} animate={inView || reduced ? { x: "100%" } : { x: 0 }} transition={{ duration: reduced ? 0 : 0.9, ease: [0.22, 1, 0.36, 1], delay: reduced ? 0 : 0.1 }} />
          <span className="glass-tag is-dark" style={{ position: "absolute", left: "6%", top: "5%", zIndex: 3 }}>Creator&rsquo;s version</span>
        </Phone>
