  ...
  return (
    <div ref={ref} className="lp-share-phone">
      <Phone large>
        ...
        <div className="lp-story-foot"><span>Send message</span><InstagramLogo size={24} color="#fff" aria-hidden /></div>
      ...
      <div style={{ position: "absolute", right: "-22%", bottom: "14%", minWidth: 170 }}>
        {step === 2 && <motion.div key="p" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="glass-panel lp-glass" style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13, fontWeight: 600 }}><UploadSimple size={20} aria-hidden />Proof submitted</motion.div>}
