...
export type Person = { id: string; name: string; city: string; portrait: string | null; initials: string; completed: number | null; rating: { value: number; count: number } | null; qualification: string; fit: string; sample: { src: string; ratio: string; title: string; kind: string } | null };

export const people: Person[] = [
  { id: "p-maya", fit: "Coffee counter Reels · Recreate and Story", name: "Maya Chen", city: "Austin", portrait: ASSET("portrait-maya-01"), initials: "MC", completed: 7, rating: { value: 4.8, count: 5 }, qualification: "Instagram Manual · 1,420 followers", sample: { src: ASSET("work-maya-loopday-01"), ratio: "9 / 16", title: "Coffee handoff", kind: "Recreate" } },
  { id: "p-eli", fit: "Workshop and repair Reels · Recreate", name: "Eli Moreno", city: "Austin", portrait: ASSET("portrait-eli-01"), initials: "EM", completed: 4, rating: { value: 4.7, count: 3 }, qualification: "Instagram connected · 2,080 followers", sample: { src: ASSET("work-eli-spurroom-01"), ratio: "4 / 5", title: "Wheel true", kind: "Recreate" } },
  { id: "p-imani", fit: "Café photography · Shoots and Recreate", name: "Imani Cole", city: "Austin", portrait: ASSET("portrait-imani-01"), initials: "IC", completed: 12, rating: { value: 4.9, count: 8 }, qualification: "Verified creator", sample: { src: ASSET("content-loopday-counter-01"), ratio: "3 / 2", title: "Counter reset", kind: "Shoot photo" } },
  { id: "p-jules", fit: "Florist detail Reels · Recreate and Story", name: "Jules Park", city: "Austin", portrait: ASSET("portrait-jules-01"), initials: "JP", completed: 3, rating: null, qualification: "Instagram connected · 1,180 followers", sample: { src: ASSET("work-jules-flowers-01"), ratio: "4 / 5", title: "Bouquet wrap", kind: "Recreate" } },
  { id: "p-nora", fit: "Lunch and takeaway Reels · Story", name: "Nora Bell", city: "Round Rock", portrait: ASSET("portrait-nora-01"), initials: "NB", completed: 5, rating: { value: 4.6, count: 4 }, qualification: "", sample: { src: ASSET("work-nora-lunch-01"), ratio: "4 / 5", title: "Lunch plate", kind: "Story" } },
