    ...
    <div className="desk">
      ...
      <main className="desk-main" id={embed ? undefined : "main"} style={{ paddingTop: 32 }}>
        ...
        <section aria-labelledby="cars-title" style={{ marginTop: 16 }}>
          ...
          <ul id={embed ? undefined : "car-shelf"} style={{ display: "flex", gap: 24, overflowX: "auto", listStyle: "none", padding: "0 0 8px", margin: "12px 0 0", scrollSnapType: "x proximity", scrollBehavior: "smooth" }}>
            {cars.map((c) => (
