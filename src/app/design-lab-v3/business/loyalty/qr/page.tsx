...
export default async function QRPage({ searchParams }: { searchParams: Promise<{ view?: string }> }) {
  ...
  return <div className="record-page"><div className="record-context" inert aria-hidden><BusinessShell bare active="Business" title="Loyalty" mainClass="loy-main"><LoyaltyHome /></BusinessShell></div><aside className="record-pane" aria-label="Counter QR"><QRView /></aside></div>;
}
