...
export const profile = {
  ...
  payoutReady: true,
  work: [
    { id: "latte-take", title: "Latte take", kind: "recreate" as Kind, business: "Loopday Coffee", media: V2ASSET("maya-loopday-submission-01"), ratio: "4 / 5", alt: "Submission still: hands placing an iced latte on a cafe counter", state: "Approved", facts: [{ label: "Approved on", value: "Aug 28, 2026" }], mediaNote: "Submission still", grossCents: 7500, feeCents: 1125, netCents: 6375, creditedOn: "Aug 28, 2026" },
    { id: "afternoon-story", title: "Afternoon Story", kind: "story" as Kind, business: "Loopday Coffee", media: ASSET("story-loopday-01"), ratio: "9 / 16", alt: "Finished Story creative for Loopday Coffee", state: "Proof approved", facts: [{ label: "Posted", value: "Aug 12, 2026, 9:10 AM CDT" }, { label: "Ended", value: "Aug 13, 2026, 9:10 AM CDT" }, { label: "Confirmed manually", value: "Aug 14, 2026" }], mediaNote: "Posted for 24 hours", grossCents: 3500, feeCents: 525, netCents: 2975, creditedOn: "Aug 14, 2026" },
    { id: "rear-door-placement", title: "Rear-door placement", kind: "car" as Kind, business: "Spurroom Bikes", media: V2ASSET("maya-spurroom-placement-01"), ratio: "3 / 2", alt: "Placement proof: a Spurroom Bikes decal on the rear door of a blue hatchback", state: "Proof approved", facts: [{ label: "Period", value: "July 2026" }, { label: "Rear doors", value: "Both doors" }], mediaNote: "Placement proof", grossCents: 36000, feeCents: 5400, netCents: 30600, creditedOn: "Aug 3, 2026" },
  ],
  vehicle: { title: "Maya’s car", photo: ASSET("vehicle-maya-01"), alt: "Maya’s listed car: a blue hatchback photographed on a residential street", listed: true, rate: null as number | null },
};
