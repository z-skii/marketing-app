...
export default async function CreatePage({ searchParams }: { searchParams: Promise<{ rec?: string }> }) {
  ...
  const kinds = [
    { key: "recreate_reel", href: `/business/create/recreate${q}`, aria: "Start a Recreate a Reel campaign", label: "Recreate", title: "Recreate a Reel", body: "Creators film their own version of your reference video.", basis: "Pay per approved video", action: "Set up a Recreate campaign",
      media: <span className="fs-create-source is-portrait is-pair"><span className="fs-create-pair"><span><Img src="/uploads/seed/tapmart-recreate.jpg" alt="" loading="eager" /><span className="fs-t-meta">Your reference</span></span><span><span className="fs-create-version" aria-hidden><span className="fs-t-meta">Filmed by the creator</span></span><span className="fs-t-meta">Their version</span></span></span></span> },
