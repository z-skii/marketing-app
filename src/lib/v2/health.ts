...
export async function getBusinessHealth(businessId: string): Promise<BusinessHealth> {
  ...
  const signals: HealthSignal[] = [
    ...
    { key: "hours", label: "Opening hours", points: 10, ok: r.hours, why: "Hours come in with your Google Business Profile connection.", fix: { href: "/business/connections", label: "Connect Google" } },
    ...
    { key: "connected", label: "A connected account", points: 10, ok: r.connected, why: "Needed for auto-posting from the content calendar.", fix: { href: "/business/connections", label: "Connect an account" } },
