...
export function LiveMain({
  ...
  return (
    <div className="grid min-h-0 flex-1 grid-cols-1 grid-rows-[minmax(clamp(10.5rem,30vh,19rem),1fr)_auto_auto] short:grid-rows-[minmax(11rem,1fr)_auto_auto] md:grid-cols-12 md:grid-rows-[minmax(0,1fr)_auto]">
      <section
        aria-label="The Spot"
